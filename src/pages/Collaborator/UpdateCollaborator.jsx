...
export const UpdateCollaborator = () => {
    ...
    const updateCollaborator = async () => {
        try {
            ...
            const { data } = await axios.put(`http://localhost:3000/user/update/${id}`, updateCollaborator, { headers: headers })
            console.log(data)
        } catch (err) {
            console.error(err)
        }
                                ...
                                <div className='form-group text-center'>
                                    ...
                                    <div className="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <Link to="/dashboard/collaborator">
                                            <button onClick={() => updateCollaborator()} className="btn btn-success">UPDATE</button>
                                        </Link>
                                        <Link to="/dashboard/collaborator">
