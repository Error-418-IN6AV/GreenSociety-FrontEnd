...
export const Image = () => {
    ...
    const handleUpload = async () => {
        try {
            if (!image) {
                Swal.fire('Oops', 'No image selected', 'error')
                return;
            }
            ...
            const response = await axios.put(`http://localhost:3000/product/uploadImage/${id}`, formData);
            Swal.fire('Save', 'Image uploaded successfully', 'success')
            getProduct()
        } catch (err) {
            console.log(err)
    ...
    return (
        <>
            ...
            <div className="modal4-body" type='file'>
                <h2 className="modal4-title">Upload a file {product.name}</h2>
            ...
            <div className="modal4-footer">
                <Link to="/product">
                    <button className="btn3-secondary">Back</button>
                </Link>
                    ...
                    <div className="col-sm-11 col-md-10 col-lg-3 mx-auto">
                        <div className="card" style={{ width: "18rem" }}>
                            <img
                                ...
                                src={product.image ? `http://localhost:3000/product/getImage/${product.image}` : '/1.png'}
                                onError={(e) => {
